...
#include "include/sprd_fb.h"
#include "include/scale_rotate.h"

#include "include/ion.h"
#include "include/ion_sprd.h"
    ...
    if (!strcmp(name, HWC_HARDWARE_COMPOSER)) {
        ...
        *device = &dev->device.common;
        ...
        if (0 == status) {
...
#endif
#endif
            dev->ion_heap = new MemoryHeapIon(SPRD_ION_DEV, dev->overlay_buf_size*OVERLAY_BUF_NUM, MemoryHeapBase::NO_CACHING, (1 << ION_HEAP_CARVEOUT_MASK));
            ...
            dev->ion_heap2 = new MemoryHeapIon(SPRD_ION_DEV, dev->overlay_buf_size2*OVERLAY_BUF_NUM, MemoryHeapBase::NO_CACHING, (1 << ION_HEAP_CARVEOUT_MASK));
            ...
            dev->ion_heap_tmp = new MemoryHeapIon(SPRD_ION_DEV, dev->overlay_buf_size_tmp, MemoryHeapBase::NO_CACHING, (1 << ION_HEAP_CARVEOUT_MASK));
